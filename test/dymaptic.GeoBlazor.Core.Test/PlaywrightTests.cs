    ...
    public async Task RunThroughScreens()
    {
        try
        {
            ...
            else
            {
                ...
                {
                    var previousFolder = Path.Combine(_screenShotsFolder, "Previous");
            ...
            {
                Path = Path.Combine(_screenShotsFolder, "Navigation1.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Navigation2.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Navigation3.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Navigation4.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Navigation_Source.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing1.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing2.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing3.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing4.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing5.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing6.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing7.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing8.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing9.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing10.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing11.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing12.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing13.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing14.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Drawing_Source.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Scene.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets1.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets2.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets3.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets4.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets5.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets6.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets7.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets8.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets9.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets10.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets11.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets12.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets13.png"),
                FullPage = true
            });

            // Click li[role="menuitem"]:has-text("Imagery Hybrid")
            await page.GetByText("Imagery Hybrid").ClickAsync();
            await Task.Delay(1000);

            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets14.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets15.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Widgets_Source.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "BaseMaps1.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "BaseMaps2.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "BaseMaps3.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "BaseMaps_Source.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "FeatureLayers1.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "FeatureLayers2.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "FeatureLayers3.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "FeatureLayers4.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "FeatureLayers5.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "FeatureLayers6.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "VectorLayer.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "VectorLayer_Source.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "WebMap1.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "WebScene1.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "SqlQuery1.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "SqlQuery2.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "SqlQuery3.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "SqlQuery4.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "SqlQuery5.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "SqlQuery_Source.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "SqlFilterQuery1.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "SqlFilterQuery2.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "SqlFilterQuery3.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "SqlFilterQuery4.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "PlaceSelector1.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "PlaceSelector2.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Routing1.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Routing2.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "Routing3.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "ServiceAreas1.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "ServiceAreas2.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "ServiceAreas3.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "ServiceAreas_Source.png"),
                FullPage = true
            });
            ...
            await page.ScreenshotAsync(new PageScreenshotOptions
            {
                Path = Path.Combine(_screenShotsFolder, "About.png"),
                FullPage = true
            });
